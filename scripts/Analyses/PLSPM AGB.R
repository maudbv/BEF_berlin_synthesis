...
prod_path = rbind( 
        ...
        soil =         c(0,0,0,0,0,0),
        Neophytes =    c(1,1,1,0,0,0),
        Plant.div =    c(1,1,1,1,0,0),
        AG_Prod =      c(1,1,1,1,1,0)
)

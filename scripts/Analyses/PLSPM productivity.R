...
plot(prod_pls_all,
     arr.pos = 0.35,
     arr.lwd = abs(10*(prod_pls$path_coefs)) )
...
plot.plspm.boot(prod_pls_all)

quartz()
plot(prod_pls_all, what="loadings")
...
plot.plspm.boot(prod_pls_redux)

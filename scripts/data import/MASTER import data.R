# Importation Master script for importing, cleaning and formatting data 
...
write.csv(EF_data, "clean data/EF_data.csv",row.names = FALSE)
write.csv(Env_data, "clean data/Environment_data.csv",row.names = FALSE)
write.csv(Biodiv_data, "clean data/Biodiversity_data.csv",row.names = FALSE)
